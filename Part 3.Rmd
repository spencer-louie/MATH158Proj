...
```
```{r, echo=FALSE, include=FALSE}
pairs(kc_data_3) #I have this on include=FALSE because there are ton of graphs so it really slow everything down to use. 
```
...
kable(cbind(dffits.kc.data_2), align = "c")
```
