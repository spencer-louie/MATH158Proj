...
```{r, echo=FALSE}
plot(kc_data$grade, kc_data$price, main="Scatterplot of Price and Grade", ylab= "Price",xlab = "Grade")
abline(lm(kc_data$price~kc_data$grade))
...
```{r, echo=FALSE}
plot(kc_data$bedbath, kc_data$price, main="Scatterplot of Price and Bed/Baths", ylab= "Price",xlab = "Bedrooms + Bathrooms")
